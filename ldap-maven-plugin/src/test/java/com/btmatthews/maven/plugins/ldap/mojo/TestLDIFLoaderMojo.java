...
public final class TestLDIFLoaderMojo extends AbstractLDAPMojoTest {
    ...
    public void testAddLDIF() throws Exception {
        ReflectionUtils.setVariableValueInObject(mojo, "ldapFiles", new File[]{ TestUtils.getFile("com/btmatthews/maven/plugins/ldap/add.ldif") });
    ...
    public void testModifyLDIF() throws Exception {
        ReflectionUtils.setVariableValueInObject(mojo, "ldapFiles", new File[]{ TestUtils.getFile("com/btmatthews/maven/plugins/ldap/modify.ldif") });
        ReflectionUtils.setVariableValueInObject(mojo, "continueOnError", Boolean.FALSE);
        mojo.execute();
    }
    ...
    public void testDeleteLDIF() throws Exception {
        ReflectionUtils.setVariableValueInObject(mojo, "ldapFiles", new File[]{ TestUtils.getFile("com/btmatthews/maven/plugins/ldap/delete.ldif") });
        ReflectionUtils.setVariableValueInObject(mojo, "continueOnError", Boolean.FALSE);
        mojo.execute();
    }
}
