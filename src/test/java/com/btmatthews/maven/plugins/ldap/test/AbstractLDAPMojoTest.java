    ...
    extends AbstractMojoTestCase
{
     ...
     */
    protected final Mojo getMojo(final String goal)
        throws Exception
    {
        final StringBuffer buffer = new StringBuffer("/target/test-classes/");
        buffer.append(this.getName());
        buffer.append("-plugin-config.xml");
        final File testPom = new File(PlexusTestCase.getBasedir(), buffer
            .toString());
    ...
    protected final void assertEquals(final Mojo mojo, final String name,
        ...
        throws Exception
    {
        TestCase.assertEquals(expectedValue, (String)this
            .getVariableValueFromObject(mojo, name));
    }
